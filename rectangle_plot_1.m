function varargout = rectangle_plot_1(varargin)
% RECTANGLE_PLOT_1 MATLAB code for rectangle_plot_1.fig
%      RECTANGLE_PLOT_1, by itself, creates a new RECTANGLE_PLOT_1 or raises the existing
%      singleton*.
%
%      H = RECTANGLE_PLOT_1 returns the handle to a new RECTANGLE_PLOT_1 or the handle to
%      the existing singleton*.
%
%      RECTANGLE_PLOT_1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RECTANGLE_PLOT_1.M with the given input arguments.
%
%      RECTANGLE_PLOT_1('Property','Value',...) creates a new RECTANGLE_PLOT_1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before rectangle_plot_1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to rectangle_plot_1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help rectangle_plot_1

% Last Modified by GUIDE v2.5 11-Jun-2016 15:59:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @rectangle_plot_1_OpeningFcn, ...
                   'gui_OutputFcn',  @rectangle_plot_1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before rectangle_plot_1 is made visible.
function rectangle_plot_1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to rectangle_plot_1 (see VARARGIN)

% Choose default command line output for rectangle_plot_1
...
% UIWAIT makes rectangle_plot_1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = rectangle_plot_1_OutputFcn(hObject, eventdata, handles) 
...
save mdfy_point1.dat pos1 -ascii
guidata(hObject, handles);
