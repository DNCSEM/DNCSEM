...
if mod(fre_mat(2,1),fre_mat(1,1))==0;fre_mat=fre_mat';end
...
%Y1(24)=0;
%Y1(L-(23-1))=0;
points_chosen0=load('pointsChosenMat.dat');
points_chosen=points_chosen0(1:4:end,:);
